...
повторяют структуру практических занятий 1–3 из [PLAN.md](../PLAN.md).
...
Полный цикл (PDF + PPTX + HTML, все три лекции):
...
## Расширение на занятия 4–12

Сейчас реализованы 3 из 12 запланированных лекций. Шаблон одной
...
Для занятий 4–12 потребуется сначала собрать соответствующие
preview-ноутбуки и графики, затем создать `04_*.md ... 12_*.md` по тому
же шаблону.
