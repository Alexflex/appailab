...
повторяют структуру практических занятий 1–6 из [PLAN.md](../PLAN.md).
...
## Расширение на занятия 7–12

Сейчас реализованы 6 из 12 запланированных лекций. Шаблон одной
...
Для занятий 7–12 потребуется сначала собрать соответствующие
preview-ноутбуки и графики, затем создать `07_*.md ... 12_*.md` по тому
же шаблону.
